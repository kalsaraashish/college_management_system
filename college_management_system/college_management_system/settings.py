...
SECRET_KEY = 'django-insecure-sek5+u6ce_v-(b7vcbia#musk6+mte_-lp-gr08blmd_g-@%d$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates",
                 BASE_DIR / "college_management_app" / "templates"
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'college_management_app.context_processors.profile_pic_context',
            ],
        },
    },
]
...
STATICFILES_DIRS = [
    BASE_DIR / "college_management_app" / "static"
]
